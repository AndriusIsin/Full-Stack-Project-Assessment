...
const AddVideo = ({ setRebuild, setVideoCards }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      fetch(
        "http://ec2-18-169-127-86.eu-west-2.compute.amazonaws.com:4000/videos",
        {
          method: "POST",
          headers: {
      ...
      alert(
        "Please enter a valid title YouTube URL (e.g., Title: Videos for Cats, URL: https://www.youtube.com/watch?v=VIDEO_ID)"
      );
    }
    setUrl("");
    setTitle("");
